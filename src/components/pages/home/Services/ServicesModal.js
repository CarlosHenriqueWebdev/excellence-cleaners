...
function ServicesModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex px-[12px] sm:px-[16px] lg:px-[32px] w-full">
      <div className="overflow-y-scroll bg-white bg-opacity-[0.90] md:bg-opacity-[1] w-full justify-start shadow-custom mx-auto max-w-[640px] md:max-w-full xl:max-w-[1280px]">
